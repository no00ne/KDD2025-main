...
class Dynamic_FC(nn.Module):
    def __init__(self, ind, outd, degree, knots, act='relu', isbias=1, islastlayer=0, dynamic_type='power'):
        ...
        if dynamic_type == 'power':
            ...
            self.spb = MLP_treatnet(num_out=32, n_hidden=32, num_in=4)
            self.d = 32
...
class ADMIT(nn.Module):
    def __init__(self, args):
        ...
        init=args.init
        self.cfg_hidden = [(input_dim, 32, 1, 'relu'), (32, 32, 1, 'relu')]
        #self.cfg_hidden = [(input_dim, 64, 1, 'relu')]
        #self.cfg = [(32, self.args.output_window, 1, 'id')]
        self.cfg = [(32, 32, 1, 'relu'), (32, self.args.output_window, 1, 'id')]
        #self.cfg = [(128, 1, 1, 'id')]
        self.degree = 2
        ...
        self.hidden_dim = self.args.input_dim
